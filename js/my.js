...
$(document).ready(function () {
  ...
  $(".part > span").on("click", function () {
    if ($(this).hasClass("active")) {
      $(this).siblings(".accordion-txt").slideUp(300);
      $(".part > span i").removeClass("fa-minus").addClass("fa-plus");
      $(this).removeClass("active");
    } else {
      $(".part > span i").removeClass("fa-minus").addClass("fa-plus");
      $(".part > span").removeClass("active");
      $(this).find("i").removeClass("fa-plus").addClass("fa-minus");
      $(".accordion-txt").slideUp(300);
      $(this).siblings(".accordion-txt").slideDown(300);
  ...
  $('.multiple-items').slick({
    ...
    centerPadding: '0px',
    adaptiveHeight: true,
    prevArrow: '<button type="button" class="slick-next"><img src="./img/study/arrow-right.png"></button">',
    nextArrow: '<button type="button" class="slick-prev"><img src="./img/study/arrow-left.png"></button>',
    responsive: [{
        breakpoint: 980,
        settings: {
          infinite: true,
...
const pointFlag = document.querySelector('#button-flag');


function flagFun() {

  flagRu.style.display = 'block';
  flagUa.style.display = 'block';

}
pointFlag.addEventListener('click', flagFun);
